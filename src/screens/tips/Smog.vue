...
<template>
  <view class="wrapper">
    ...
    <touchable-opacity class="plate"
      ...
      <text class="button">Scarica l'app</text>
    </touchable-opacity>
  </view>
</template>
...
import Warning from '../../components/tips/Warning.vue'
...
export default {
  ...
  methods: {
    openLink(link) {
      if (link === 'ios') {
        Linking.openURL('https://apps.apple.com/us/app/air-matters/id477700080')
      } else {
        Linking.openURL('https://play.google.com/store/apps/details?id=com.freshideas.airindex&hl=en&gl=US')
      }
    }
  }
}
